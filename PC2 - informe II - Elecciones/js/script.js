...
//Esto vamos a inyectarlo en la clase graficoTarta de html
function imprimirGraficoTarta(){
  //El primer parámetro es el contenedor 
  //El segundo parámetro es la configuracion: que copiamos de chat.js
